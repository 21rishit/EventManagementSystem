...
export default function EventPage() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`events/${id}/ordersummary`) // Updated API URL
      .then((response) => {
  ...
  if (!event) return null; // Returns null instead of an empty string for better performance
  ...
  return (
    <div className="flex flex-col mx-5 xl:mx-32 md:mx-10 mt-5 flex-grow">
      ...
      {/* FIXME: Demo image - remove after API integration */}

      {/* Event Title & Booking Button */}
      ...
      {/* Description */}
      <div className="mx-2 mt-5 text-md md:text-lg truncate-3-lines">{event.description}</div>
