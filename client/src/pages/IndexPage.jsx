...
export default function IndexPage() {
  ...
  useEffect(() => {
    axios
      .get("events/allEvent", { withCredentials: true })
      .then((response) => {
  ...
  const handleLike = (eventId) => {
    axios
      .post(`events/${eventId}/like`, {}, { withCredentials: true })
      .then((response) => {
      ...
      <div className="mt-1 flex flex-col">
        <div className="hidden sm:block">
          <div className="flex item-center inset-0">
            <img src="../src/assets/hero.jpg" alt="Hero" className="w-full" />
          </div>
        </div>
              ...
              if (eventDate > currentDate || eventDate.toDateString() === currentDate.toDateString()) {
                return (
                  <div className="bg-white rounded-xl relative" key={event._id}>
                    ...
                    {/* <img src="../src/assets/paduru.png" alt="Placeholder" className="rounded-tl-[0.75rem] rounded-tr-[0.75rem] object-fill aspect-16:9" /> */}
                    {/* FIXME: This is a demo image, delete after implementing event image logic */}
